...
// template
    ...
    [BASE_FN] = LAYOUT_ansi_67(        // layer 2 - cyan
        ...
        KC_TAB,         KC_MVLT, KC_MVRT, KC_EMOC, _______, TG(1),   _______, _______, KC_UP,   KC_MVLT, KC_MVRT, KC_BRID, KC_BRIU, KC_BSPC,       LT(4,KC_GRV),
        KC_CAPS,          KC_MVLS, KC_MVRS, KC_DESK, KC_FSTG, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_MVLS, KC_MVRS,        KC_ENT,        LT(3,KC_BSLS),
