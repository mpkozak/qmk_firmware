...
// template
    ...
    [BASE_SPD] = LAYOUT_ansi_67(    // layer 1 - cyan
    ...
    [BASE_FN] = LAYOUT_ansi_67(        // layer 2 - blue
        ...
        KC_TAB,         KC_MVLT, KC_MVRT, KC_EMOC, KC_NO,   TG(1),   KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_NO,   KC_MVLS, KC_MVRS, KC_DEL,        LT(4,KC_GRV),
    ...
    [_FN1] = LAYOUT_ansi_67(        // layer 3 - orange [right-side arrows + quick toggles]
        ...
        _______,        KC_MVLT, KC_MVRT, KC_EMOC, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_UP,   KC_MVLT, KC_MVRT, _______,       _______,
