...
#define KC_RFRT LT(3, KC_RGHT)  // right fn (layer 3) under right arrow
...
// template
    ...
    [BASE] = LAYOUT_ansi_60(        // layer 0 BASE - white
        ...
        KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,             KC_RSUP, KC_RFRT,
                    KC_LOPT,  KC_LCMD,                                LT(2,KC_SPC),                           KC_RCLF,  KC_RODN),
