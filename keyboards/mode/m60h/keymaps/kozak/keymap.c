...
#define KC_RSDN RSFT_T(KC_DOWN) // right shift under down arrow
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_60_hhkb(       // layer 0 BASE - white
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSUP, LT(2, KC_LEFT),
    ...
    [BASE_FN] = LAYOUT_60_hhkb(    // layer 1 BASE_FN - blue
        ...
        KC_LSFT,          KC_ZMNS, KC_ZPLS, KC_ZACT, KC_PSTT, KC_WBAK, KC_WFOR, KC_NO,   KC_MVLT, KC_MVRT, KC_CMNT, KC_RSDN, LT(2, KC_RGHT),
