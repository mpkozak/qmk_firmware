...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_60_hhkb(       // layer 0 BASE - white
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, UP_RSFT, RGHT_L3,
                          KC_LOPT, KC_LCMD,                   LT(2,KC_SPC),                       LFT_CMD, DWN_OPT
    ),
    [SPD] = LAYOUT_60_hhkb(       // layer 1 SPD - orange
