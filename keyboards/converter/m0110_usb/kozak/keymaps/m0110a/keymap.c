...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_m0110a(
        ...
        OPT_CTL, CMD_CTL,                            LT(1,KC_SPC),                                BSL_CMD, LFT_OPT, KC_RGHT, LT(1, KC_DOWN),  LT(1, KC_P0),     KC_PDOT
    ),
    [FN0] = LAYOUT_m0110a(
        ...
        KC_INS,  ___x___, KC_UP,   KC_EMOC, KC_REFR, TO(2),   ___x___, ___x___, KC_UP,   ___x___, ___x___, KC_MVLT, KC_MVRT,                  KC_BTAB, KC_UP,   KC_TAB,  KC_VOLD,
    ...
    [SPD] = LAYOUT_m0110a(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    ___x___, ___x___,                  _______, _______, _______, _______,
