...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_m0110a_v2(
        ESC_GRV, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,         KC_BSPC, KC_PEQL, KC_PSLS, KC_PAST,
        ...
        OPT_CTL, CMD_CTL,                            LT(1,KC_SPC),                                KC_RCMD, LFT_OPT, KC_RGHT, LT(1, KC_DOWN),  LT(1, KC_P0),     KC_PDOT
    ),
    [FN0] = LAYOUT_m0110a_v2(
        KC_LSCR, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,          KC_BSPC, KC_CALU, ___x___, KC_MUTE,
        KC_INS,  ___x___, KC_UP,   KC_EMOC, KC_REFR, TO(2),   ___x___, ___x___, KC_UP,   ___x___, ___x___, KC_MVLT, KC_MVRT, TO(3),           KC_BTAB, KC_UP,   KC_TAB,  KC_VOLD,
        ...
        _______,          KC_ZMNS, KC_ZPLS, KC_ZACT, KC_PSTT, KC_WBAK, KC_WFOR, ___x___, KC_MCTL, KC_MVLS, KC_MVRS, ___x___, _______,         G(KC_1), G(KC_2), G(KC_3), _______,
        KC_APFN, _______,                            _______,                                     _______, _______, KC_DESK, _______,         _______,          MO(2)
    ),
    [SPD] = LAYOUT_m0110a_v2(
        TO(0),   KC_1,    KC_P2,   KC_P3,   KC_P4,   KC_P5,   KC_P6,   KC_P7,   KC_P8,   KC_9,    KC_0,    KC_MINS, ___x___, KC_BSPC,         QK_BOOT, QK_RBT,  DB_TOGG, TT(3),
        ...
        OSM(MOD_LSFT),    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUES, ___x___, _______,         _______, _______, _______, _______,
    ...
    [DFLT] = LAYOUT_m0110a_v2(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, TO(0),           KC_P7,   KC_P8,   KC_P9,   KC_PMNS,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,          KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ___x___, KC_UP,           KC_P1,   KC_P2,   KC_P3,   KC_PENT,
