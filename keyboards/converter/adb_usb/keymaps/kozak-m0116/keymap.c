...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_m0116_ansi(
        ...
        KC_LCAP, KC_LOPT, KC_LCMD, KC_CMDG,                   LT(1,KC_SPC),              KC_CMDB, KC_OPTL, KC_RGHT, KC_DOWN, LT(2,KC_UP),     LT(2, KC_P0),     KC_PDOT, KC_PENT
    ),
    [BASE_FN] = LAYOUT_m0116_ansi(
        ...
        _______,          KC_ZMNS, KC_ZPLS, KC_ZACT, KC_PSTT, KC_WBAK, KC_WFOR, KC_NO,   KC_MVLT, KC_MVRT, KC_CMNT,          _______,         _______, _______, _______,
        _______, _______, _______, _______,                   _______,                   _______, _______, _______, _______, _______,         _______,          _______, _______
    ),
    [_FN1] = LAYOUT_m0116_ansi(
                                                     QK_BOOT,
        KC_LSCR, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, KC_MUTE,         QK_BOOT, KC_NO,   KC_NO,   KC_MUTE,
        KC_INS,  KC_MVLT, KC_MVRT, KC_EMOC, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_UP,   KC_MVLT, KC_MVRT,                  KC_NO,   KC_UP,   KC_NO,   KC_VOLU,
        _______, KC_MVLS, KC_MVRS, KC_DESK, KC_FSTG, KC_NO,   KC_NO,   KC_NO,   KC_LPAD, KC_LEFT, KC_DOWN, KC_RGHT,          _______,         KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLD,
