...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN1] = LAYOUT_m0116(
        ...
        _______, _______, _______, _______,                   G(KC_SPC),                 _______, KC_MVLS, KC_MVRS, KC_DESK, _______,         _______,          ___x___, _______
    ),
    [BASE_SPD] = LAYOUT_m0116(
                                                     TO(0),
        TO(0),   KC_1,    KC_P2,   KC_P3,   KC_P4,   KC_P5,   KC_P6,   KC_P7,   KC_P8,   KC_9,    KC_0,    KC_MINS, ___x___, KC_BSPC,         KC_DEL,  KC_PEQL, KC_PSLS, KC_PAST,
        ...
        ___x___, KC_LOPT, KC_LCMD, MO(2),                     LT(1,KC_SPC),              KC_CMDA, KC_OPTA, KC_RGHT, KC_DOWN, LT(2,KC_UP),     LT(2, KC_P0),     KC_PDOT, LT(2, KC_PENT)
    )
};
